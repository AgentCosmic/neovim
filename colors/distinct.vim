...
call s:h('SpecialComment', {'fg': s:grey75, 'gui': 'italic'})
...
call s:h('Todo', {'fg': s:grey85, 'gui': 'bold,italic'})
...
call s:h('Search', {'fg': s:grey95, 'bg': s:highlight})
...
call s:h('StatusArrowModified', {'fg': s:green, 'bg': s:grey10})
